...
import com.kirill1995.kazzak.ui.ErrorFragment
...
class HomeFragment : Fragment(R.layout.fragment_home), StringBuilder, DateConverter {
    ...
    private fun checkErrorFromApi() {
        vm.errorLiveData.observe(viewLifecycleOwner) { errorMasage ->
            if (errorMasage == "Error") {
